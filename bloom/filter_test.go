...
func TestFilterInsertKey(t *testing.T) {
	secret := "5Kg1gnAjaLfKiwhhPpGS3QfRg2m6awQvaj98JCZBZQ5SuT2mcX7"
...
func TestFilterBloomMatch(t *testing.T) {
	...
	spendingTxBytes := []byte{0x01, 0x00, 0x00, 0x00, 0x01, 0x26, 0xa0, 0xea,
		0x78, 0x35, 0x03, 0x65, 0xc6, 0x1c, 0xf3, 0xf5, 0xfc,
		0x3d, 0x5c, 0x4f, 0xeb, 0x7d, 0xe8, 0xed, 0x86, 0x0a,
		0xe3, 0xe8, 0x28, 0x74, 0xbc, 0xc5, 0x5e, 0xa0, 0xf7,
		0x08, 0xc2, 0x00, 0x00, 0x00, 0x00, 0x8c, 0x49, 0x30,
	...
	inputStr := "c208f7a05ec5bc7428e8e30a86ede87deb4f5c3dfcf5f31cc665033578eaa026"
	...
	f = bloom.NewFilter(10, 0, 0.000001, wire.BloomUpdateAll)
	inputStr = "26a0ea78350365c61cf3f5fc3d5c4feb7de8ed860ae3e82874bcc55ea0f708c2"
...
func TestFilterInsertP2PubKeyOnly(t *testing.T) {
	...
	inputStr = "fa24c96f171c4636a95b24b8601e043c727f8e061bcc2bf3214ff1830c22bbbd"
	hash, err := chainhash.NewHashFromStr(inputStr)
	if err != nil {
