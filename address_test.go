...
func TestAddresses(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			addr:    "LM2WMpR1Rp6j3Sa59cMXMs1SPzj9gkdLVN",
			encoded: "LM2WMpR1Rp6j3Sa59cMXMs1SPzj9gkdLVN",
			valid:   true,
			result: btcutil.TstAddressPubKeyHash(
				[ripemd160.Size]byte{
		...
		},
		{
			...
			addr:    "MVcg9uEvtWuP5N6V48EHfEtbz48qTpCoeQ",
			encoded: "MVcg9uEvtWuP5N6V48EHfEtbz48qTpCoeQ",
			valid:   true,
			result: btcutil.TstAddressScriptHash(
				[ripemd160.Size]byte{
